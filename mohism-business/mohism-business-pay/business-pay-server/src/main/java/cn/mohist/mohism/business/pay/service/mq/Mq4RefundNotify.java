package cn.mohist.mohism.business.pay.service.mq;

import cn.mohist.mohism.business.pay.api.IPayChannel4AliService;
import cn.mohist.mohism.business.pay.api.IPayChannel4WxService;
import cn.mohist.mohism.business.pay.model.RefundOrder;
import cn.mohist.mohism.business.pay.service.BaseNotify4MchRefund;
import cn.mohist.mohism.business.pay.service.BaseService4RefundOrder;
import cn.mohist.mohism.pay.constant.PayConstant;
import cn.mohist.mohism.pay.util.MyLog;
import cn.mohist.mohism.pay.util.RpcUtil;
import cn.mohist.mohism.pay.util.StrUtil;
...
//    private IPayChannel4WxService payChannel4WxService;
    ...
    public void receive(String msg) {
        ...
        if(PayConstant.CHANNEL_NAME_WX.equalsIgnoreCase(channelName)) {
            resultMap = null;//payChannel4WxService.doWxRefundReq(jsonParam);
