 ...
 */
package cn.mohist.mohism.common.logger.chain.context;


import cn.mohist.mohism.common.gm.api.base.AbstractBaseRequest;
import cn.mohist.mohism.common.gm.constants.MohismConstants;
...
public class SpanIdContext {
    ...
    public static String getSpanIdByHttpHeader() {
        ...
        if (request == null) {
            ...
            String requestNo = request.getHeader(MohismConstants.SPAN_ID_HEADER_NAME);
