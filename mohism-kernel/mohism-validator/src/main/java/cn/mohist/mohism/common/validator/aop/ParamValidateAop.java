 ...
 */
package cn.mohist.mohism.common.validator.aop;

import cn.mohist.mohism.common.gm.constants.AopSortConstants;
...
public class ParamValidateAop {
    ...
    @Pointcut(value = "@annotation(cn.mohist.mohism.common.validator.ParamValidato)")
